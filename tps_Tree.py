...
if __name__ == "__main__":
    ...
    First_Tree.output_tree(Bios, Details, Checks, Areas, file0 = "10092015_basic.csv", file1 = "10092015_checks.csv", file2 = "10092015_hectare.csv", mode='wt')
    ...
    for each_tree in sample_trees[1:]:
        ...
        A.output_tree(Bios, Details, Checks, Areas, file0 = "10092015_basic.csv", file1 = "10092015_checks.csv", file2 = "10092015_hectare.csv", mode='a')
