...
class Tree(object):
    ...
    def compute_biomasses(self):
        ...
        **INTERNAL VARIABLES**
        ...
        :proxy_dbh: in years where the dbh is not extant because of mortality, the proxy dbh is used to compute the biomasses. It is the dbh of the last live remeasurement.
